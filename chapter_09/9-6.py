...
##creating a list of flavors since I was having trouble passing a direct list
##after that it passes the default names/values for the stand and prints the flavors
Spacekinflavors = ["Chocolate", "Vanilla", "Strawberry", "Every flavor", "Poop"]
SpacekinRobins = IceCreamStand("Spacekin Robins", "Astronaut Ice Cream", Spacekinflavors)
